...
public class DoctorAppointmentDetails extends javax.swing.JFrame {
    ...
    public DoctorAppointmentDetails() {
        ...
        DataController.loadComboBox(combo_appointCode, "select appoint_id from appointment");
        viewDoctorSpecificAppointments();
    }
    public DoctorAppointmentDetails(String doctorCode) {
        initComponents();
        ...
        DataController.loadComboBox(combo_appointCode, "select appoint_id from appointment where doctor_code = '" + doctorCode + "'");
        viewDoctorSpecificAppointments();
    }
    
    public void viewDoctorSpecificAppointments(){
        ...
        String sql = "select * from appointment where doctor_code = '" + doctorCode + "'";
        try {
    ...
    private void initComponents() {
        ...
        combo_appointCode = new javax.swing.JComboBox();
        ...
        txt_appointDate.setBounds(1060, 190, 190, 30);

        jLabel22.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        jLabel22.setText("Appoint Time");
        jPanel2.add(jLabel22);
        jLabel22.setBounds(930, 240, 110, 30);
        ...
        txt_appointTime.setBounds(1060, 240, 190, 30);
        ...
        combo_doctorCode.setBounds(270, 200, 170, 30);
        ...
        combo_patientCode.setBounds(270, 250, 170, 30);
        jPanel2.add(txt_patientName);
        txt_patientName.setBounds(640, 250, 190, 30);

        combo_status.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pending", "Done", "Absent" }));
        jPanel2.add(combo_status);
        combo_status.setBounds(270, 300, 170, 30);

        combo_appointCode.setEditable(true);
        combo_appointCode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Write ID" }));
        combo_appointCode.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                combo_appointCodeItemStateChanged(evt);
            }
        });
        jPanel2.add(combo_appointCode);
        combo_appointCode.setBounds(270, 140, 170, 30);
        ...
        jScrollPane1.setBounds(12, 382, 1330, 310);
    ...
    private HashMap getAppointmentDetails() {
        ...
        appointDetails.put("appoint_id", combo_appointCode.getSelectedItem());
    ...
    private void combo_appointCodeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_combo_appointCodeItemStateChanged
        if (combo_appointCode.getSelectedIndex() > 0) {
            Connection con = null;
            ...
            try {
                ...
                rst = cstmt.executeQuery("select * from appointment where appoint_id = '" + combo_appointCode.getSelectedItem().toString() + "'");
    ...
    }//GEN-LAST:event_combo_appointCodeItemStateChanged
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorAppointmentDetails().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox combo_appointCode;
