 ...
 * @author dinis
 */
public class DoctorViewPatient extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorViewPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
