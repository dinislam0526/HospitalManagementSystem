 ...
 * @author dinis
 */
public class PharmacistDetail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Pharmacist Details");
    ...
    private void addbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbtnActionPerformed
       String ph_code = txtcode.getText();
       ...
       String sql = "insert into pharmacists(ph_code,fname,lname,age,marital_status,gender,address,qualification,join_date,leaving_date,user_name,password,phone) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
       
       try {
           Connection con = DBConnection1.getDBConnection1();
           PreparedStatement  stmt = con.prepareStatement(sql);
            stmt.setString(1, ph_code);
            ...
            JOptionPane.showMessageDialog(null, "Pharmacist Added successful !");
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnActionPerformed
       ...
       String sql = "update pharmacists set ph_code = ?, fname = ?,lname = ?,age = ?,marital_status = ?,gender = ?,address = ?,qualification = ?,join_date = ?,leaving_date = ?,user_name = ?,password = ?,phone = ? where ph_code = ?" ;
       ...
       try {
           ...
           PreparedStatement  stmt = con.prepareStatement(sql);
            ...
            stmt.setString(12, password);
            stmt.setString(13, phone);
            stmt.setString(14, ph_code);
            
            int status = stmt.executeUpdate();
            JOptionPane.showMessageDialog(null, "Pharmacists update successful !");
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        ...
        String sql = "delete from pharmacists where  ph_code = ?";
           try {
            ...
            if(deleteStatus == 0){
               ...
               JOptionPane.showMessageDialog(null, "The Pharmacist has beeen deleted!");
    ...
    private void searchbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchbtnActionPerformed
       String ph_code = txtsearch.getText();
        
       
          String update = "select * from pharmacists where ph_code = ?";
            try {
                Connection con = DBConnection1.getDBConnection1();
                PreparedStatement psmt = con.prepareStatement(update);
                psmt.setString(1, ph_code);
                ResultSet rs = psmt.executeQuery();
              
                if(rs.next()){
              
                txtcode.setText(rs.getString("ph_code"));
                ...
                txtphone.setText(rs.getString("phone"));
                    ...
                    JOptionPane.showMessageDialog(null, "Pharmacist code does not match");
                }
                setVisible(true);
            } catch (Exception e) {
                System.out.println(e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PharmacistDetail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
